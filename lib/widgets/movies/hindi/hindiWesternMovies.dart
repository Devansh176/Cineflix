...
class HindiWesternMovies extends StatefulWidget {
  const HindiWesternMovies({super.key, required this.hindiWesternMovies});
  final List hindiWesternMovies;
...
class _HindiWesternMoviesState extends State<HindiWesternMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget westernMovies: ${widget.hindiWesternMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedWesternBox = widget.hindiWesternMovies;
      });
      westernBox.put('westernHindiMovies', widget.hindiWesternMovies);
    }
  }
