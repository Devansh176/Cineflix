...
class HindiThrillerMovies extends StatefulWidget {
  const HindiThrillerMovies({super.key, required this.hindiThrillerMovies});
  final List hindiThrillerMovies;
...
class _HindiThrillerMoviesState extends State<HindiThrillerMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget thrillerMovies: ${widget.hindiThrillerMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedThrillerMovies = widget.hindiThrillerMovies;
      });
      thrillerBox.put('thrillerHindiMovies', widget.hindiThrillerMovies);
    }
  }
