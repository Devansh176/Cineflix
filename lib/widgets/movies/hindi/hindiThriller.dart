...
class HindiThrillerMovies extends StatefulWidget {
  const HindiThrillerMovies({super.key, required this.thrillerHindiMovies});
  final List thrillerHindiMovies;

  @override
  State<HindiThrillerMovies> createState() => _HindiThrillerMoviesState();
}

class _HindiThrillerMoviesState extends State<HindiThrillerMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = thrillerBox.get('thrillerHindiMovies');
      final cachedTimestamp = thrillerBox.get('thrillerHindiMoviesTimestamp');
      ...
      await thrillerBox.put('thrillerHindiMovies', widget.thrillerHindiMovies);
      await thrillerBox.put('thrillerHindiMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.thrillerHindiMovies;
    } catch (e) {
      return [];
    }
  }
