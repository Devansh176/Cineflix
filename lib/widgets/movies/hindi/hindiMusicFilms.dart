...
class HindiMusicFilms extends StatefulWidget {
  const HindiMusicFilms({super.key, required this.hindiMusicFilms});
  final List hindiMusicFilms;
...
class _HindiMusicFilmsState extends State<HindiMusicFilms> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget musicFilms: ${widget.hindiMusicFilms.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedMusicFilms = widget.hindiMusicFilms;
      });
      musicBox.put('musicHindiFilms', widget.hindiMusicFilms);
    }
  }
