...
class HindiHistoryMovies extends StatefulWidget {
  const HindiHistoryMovies({super.key, required this.historyHindiMovies});
  final List historyHindiMovies;
...
class _HindiHistoryMoviesState extends State<HindiHistoryMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = historyBox.get('historyHindiMoviesTimestamp');
      ...
      await historyBox.put('historyHindiMovies', widget.historyHindiMovies);
      await historyBox.put('historyHindiMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.historyHindiMovies;
    } catch (e) {
      return [];
    }
  }
