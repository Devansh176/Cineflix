...
class HindiFamilyMovies extends StatefulWidget {
  const HindiFamilyMovies({super.key, required this.hindiFamilyMovies});
  final List hindiFamilyMovies;
...
class _HindiFamilyMoviesState extends State<HindiFamilyMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget actionMovies: ${widget.hindiFamilyMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedFamilyMovies = widget.hindiFamilyMovies;
      });
      familyBox.put('familyHindiMovies', widget.hindiFamilyMovies);
    }
  }
