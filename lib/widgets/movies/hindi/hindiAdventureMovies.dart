...
class HindiAdventureMovies extends StatefulWidget {
  const HindiAdventureMovies({super.key, required this.adventureHindiMovies});
  final List adventureHindiMovies;
...
class _HindiAdventureMoviesState extends State<HindiAdventureMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = adventureBox.get('adventureHindiMoviesTimestamp');
      ...
      await adventureBox.put('adventureHindiMovies', widget.adventureHindiMovies);
      await adventureBox.put('adventureHindiMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.adventureHindiMovies;
    } catch (e) {
      return [];
    }
  }
