...
class HindiDocumentaryMovies extends StatefulWidget {
  const HindiDocumentaryMovies({super.key, required this.hindiDocumentaryMovies});
  final List hindiDocumentaryMovies;
...
class _HindiDocumentaryMoviesState extends State<HindiDocumentaryMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget documentaryMovies: ${widget.hindiDocumentaryMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedDocMovies = widget.hindiDocumentaryMovies;
      });
      documentaryBox.put('documentaryHindiMovies', widget.hindiDocumentaryMovies);
    }
  }
