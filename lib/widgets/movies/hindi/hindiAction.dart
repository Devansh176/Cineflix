...
class _HindiActionMoviesState extends State<HindiActionMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget actionMovies: ${widget.hindiActionMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null) {
      ...
      setState(() {
        cachedActionMovies = widget.hindiActionMovies;
      });
      actionBox.put('actionHindiMovies', widget.hindiActionMovies);
    }
  }
