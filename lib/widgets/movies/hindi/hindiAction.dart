...
//
// class HindiActionMovies extends StatefulWidget {
//   const HindiActionMovies({super.key, required this.hindiActionMovies});
//   final List hindiActionMovies;
//
//   @override
//   State<HindiActionMovies> createState() => _HindiActionMoviesState();
// }
//
// class _HindiActionMoviesState extends State<HindiActionMovies> {
//   late Box actionBox;
...
//       try {
//         if (Hive.isBoxOpen('ActionMoviesBox')) {
//           print("Hive Box is already opened.");
//           actionBox = Hive.box('ActionMoviesBox');
//         } else {
...
//       }
//
//       final cachedData = actionBox.get('actionHindiMovies');
//       final cachedTimestamp = actionBox.get('actionHindiMoviesTimestamp');
//
...
//       }
//
//       await actionBox.put('actionHindiMovies', widget.hindiActionMovies);
//       await actionBox.put('actionHindiMoviesTimestamp', DateTime.now().toIso8601String());
//
//       return widget.hindiActionMovies;
//     } catch (e) {
//       return [];
//     }
//   }
