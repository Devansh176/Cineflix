...
class HindiMysteryMovies extends StatefulWidget {
  const HindiMysteryMovies({super.key, required this.mysteryHindiMovies});
  final List mysteryHindiMovies;
...
class _HindiMysteryMoviesState extends State<HindiMysteryMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = mysteryBox.get('mysteryHindiMoviesTimestamp');
      ...
      await mysteryBox.put('mysteryHindiMovies', widget.mysteryHindiMovies);
      await mysteryBox.put('mysteryHindiMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.mysteryHindiMovies;
    } catch (e) {
      return [];
    }
  }
