...
class _WesternMoviesState extends State<WesternMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = westernBox.get('westernMoviesTimestamp');
      ...
      await westernBox.put('westernMovies', widget.westernMovies);
      await westernBox.put('westernMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.westernMovies;
    } catch (e) {
      return [];
    }
  }
