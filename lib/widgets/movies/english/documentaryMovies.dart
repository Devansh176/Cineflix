...
class _DocumentaryMoviesState extends State<DocumentaryMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = documentaryBox.get('documentaryMoviesTimestamp');
      ...
      await documentaryBox.put('documentaryMovies', widget.documentaryMovies);
      await documentaryBox.put('documentaryMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.documentaryMovies;
    } catch (e) {
      return [];
    }
  }
