...
class _MusicFilmsState extends State<MusicFilms> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = musicBox.get('musicFilmsTimestamp');
      ...
      await musicBox.put('musicFilms', widget.musicFilms);
      await musicBox.put('musicFilmsTimestamp', DateTime.now().toIso8601String());

      return widget.musicFilms;
    } catch (e) {
      return [];
    }
  }
