...
class _AnimationMoviesState extends State<AnimationMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget animationMovies: ${widget.animationMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedAnimationMovies = widget.animationMovies;
      });
      animationBox.put('animationMovies', widget.animationMovies);
    }
  }
