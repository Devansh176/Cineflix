...
class _PopularMoviesState extends State<PopularMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = popularBox.get('popularMoviesTimestamp');
      ...
      await popularBox.put('popularMovies', widget.popularMovies);
      await popularBox.put('popularMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.popularMovies;
    } catch (e) {
      return [];
    }
  }
