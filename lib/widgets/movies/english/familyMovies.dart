...
class _FamilyMoviesState extends State<FamilyMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = familyBox.get('familyMoviesTimestamp');
      ...
      await familyBox.put('familyMovies', widget.familyMovies);
      await familyBox.put('familyMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.familyMovies;
    } catch (e) {
      return [];
    }
  }
