...
class _ActionMoviesState extends State<ActionMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = actionBox.get('actionMoviesTimestamp');
      ...
      await actionBox.put('actionMovies', widget.actionMovies);
      await actionBox.put('actionMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.actionMovies;
    } catch (e) {
      return [];
    }
  }
