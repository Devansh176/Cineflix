...
class ScienceFictionMovies extends StatefulWidget {
  const ScienceFictionMovies({super.key, required this.scienceFictionMovies});
  final List scienceFictionMovies;
...
class _ScienceFictionMoviesState extends State<ScienceFictionMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = scienceFictionBox.get('sciFiMovies');
      final cachedTimestamp = scienceFictionBox.get('sciFiMoviesTimestamp');
      ...
      await scienceFictionBox.put('sciFiMovies', widget.scienceFictionMovies);
      await scienceFictionBox.put('sciFiMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.scienceFictionMovies;
    } catch (e) {
      return [];
    }
  }
