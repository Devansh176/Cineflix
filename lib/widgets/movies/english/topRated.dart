...
class _TopRatedMoviesState extends State<TopRatedMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = topRatedBox.get('topRatedMovies');
      final cachedTimestamp = topRatedBox.get('topRatedMoviesTimestamp');
      ...
      await topRatedBox.put('westernMovies', widget.topRatedMovies);
      await topRatedBox.put('westernMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.topRatedMovies;
    } catch (e) {
      return [];
    }
  }
