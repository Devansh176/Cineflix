...
class _ComedyMoviesState extends State<ComedyMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = comedyBox.get('comedyMovies');
      final cachedTimestamp = comedyBox.get('comedyMoviesTimestamp');
      ...
      await comedyBox.put('comedyMovies', widget.comedyMovies);
      await comedyBox.put('comedyMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.comedyMovies;
    } catch (e) {
      return [];
    }
  }
