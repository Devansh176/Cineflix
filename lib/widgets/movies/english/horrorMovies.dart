...
class _HorrorMoviesState extends State<HorrorMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = horrorBox.get('horrorMoviesTimestamp');
      ...
      await horrorBox.put('horrorMovies', widget.horrorMovies);
      await horrorBox.put('horrorMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.horrorMovies;
    } catch (e) {
      return [];
    }
  }
