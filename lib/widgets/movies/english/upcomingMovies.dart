...
class _UpcomingMoviesState extends State<UpcomingMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = upcomingBox.get('upcomingMovies');
      final cachedTimestamp = upcomingBox.get('upcomingMoviesTimestamp');
      ...
      await upcomingBox.put('upcomingMovies', widget.upcomingMovies);
      await upcomingBox.put('upcomingMoviesTimestamp', DateTime.now().toIso8601String());

      return widget.upcomingMovies;
    } catch (e) {
      return [];
    }
  }
