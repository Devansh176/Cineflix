...
class _UpcomingMoviesState extends State<UpcomingMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget upcomingMovies: ${widget.upcomingMovies.length}");
  }
  ...
  void loadMovies() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedUpcomingMovies = widget.upcomingMovies;
      });
      upcomingBox.put('upcomingMovies', widget.upcomingMovies);
    }
  }
