...
class _TrendingMoviesState extends State<TrendingMovies> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = trendingBox.get('trendingMovies');
      final cachedTimestamp = trendingBox.get('trendingMoviesTimestamp');
      ...
      await trendingBox.put('trendingMovies', widget.trendingMovies);
      await trendingBox.put('trendingMoviesTimestamp', DateTime.now().toIso8601String());
