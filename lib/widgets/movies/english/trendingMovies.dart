...
class _TrendingMoviesState extends State<TrendingMovies> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget trendingMovies: ${widget.trending.length}");
  }
  ...
  void loadMovies() {
    final cachedData = trendingMoviesBox.get('trendingMovies');
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedTrendingMovies = widget.trending;
      });
      trendingMoviesBox.put('trendingMovies', widget.trending);
    }
  }
