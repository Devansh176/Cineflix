...
class Reality extends StatefulWidget {
  ...
  @override
  State<Reality> createState() => _RealityState();
}
...
class _RealityState extends State<Reality> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget realityShow: ${widget.realityShow.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedRealityShow = widget.realityShow;
      });
      seriesRealityBox.put('realityShow', widget.realityShow);
    }
  }
