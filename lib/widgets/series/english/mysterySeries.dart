...
class _MysterySeriesState extends State<MysterySeries> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = seriesMysteryBox.get('mysterySeriesTimestamp');
      ...
      await seriesMysteryBox.put('mysterySeries', widget.mysterySeries);
      await seriesMysteryBox.put('mysterySeriesTimestamp', DateTime.now().toIso8601String());

      return widget.mysterySeries;
    } catch (e) {
      return [];
    }
  }
