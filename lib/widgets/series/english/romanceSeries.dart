...
class _RomanceSeriesState extends State<RomanceSeries> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = seriesRomanceBox.get('romanceSeriesTimestamp');
      ...
      await seriesRomanceBox.put('romanceSeries', widget.romanceSeries);
      await seriesRomanceBox.put('romanceSeriesTimestamp', DateTime.now().toIso8601String());

      return widget.romanceSeries;
    } catch (e) {
      return [];
    }
  }
