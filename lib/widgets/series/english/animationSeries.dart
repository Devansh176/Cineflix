...
class _AnimationSeriesState extends State<AnimationSeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget animationMovies: ${widget.animationSeries.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedAnimationSeries = widget.animationSeries;
      });
      seriesAnimationBox.put('animationSeries', widget.animationSeries);
    }
  }
