...
class _ActionSeriesState extends State<ActionSeries> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = seriesActionBox.get('actionSeriesTimestamp');
      ...
      await seriesActionBox.put('actionSeries', widget.actionSeries);
      await seriesActionBox.put('actionSeriesTimestamp', DateTime.now().toIso8601String());

      return widget.actionSeries;
    } catch (e) {
      return [];
    }
  }
