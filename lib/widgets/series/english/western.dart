...
class _WesternSeriesState extends State<WesternSeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget Western Series : ${widget.westernSeries.length}");
  }
  ...
  void loadSeries() {
    final cachedData = seriesWestern.get('westernSeries');
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedWesternSeries = widget.westernSeries;
      });
      seriesWestern.put('westernSeries', widget.westernSeries);
    }
  }
