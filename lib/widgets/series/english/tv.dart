...
class _TvShowsState extends State<TvShows> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = tvShowsBox.get('tvShows');
      final cachedTimestamp = tvShowsBox.get('tvShowsTimestamp');
      ...
      await tvShowsBox.put('tvShows', widget.tvShows);
      await tvShowsBox.put('tvShowsTimestamp', DateTime.now().toIso8601String());

      return widget.tvShows;
    } catch (e) {
      return [];
    }
  }
