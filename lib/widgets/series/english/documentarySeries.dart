...
class DocSeries extends StatefulWidget {
  const DocSeries({super.key, required this.documentarySeries});
  final List documentarySeries;

  @override
  State<DocSeries> createState() => _DocSeriesState();
}

class _DocSeriesState extends State<DocSeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget Documentary Series: ${widget.documentarySeries.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      print("Cached data found in documentary: ${cachedData.length}");
      setState(() {
      ...
      setState(() {
        cachedDocumentarySeries = widget.documentarySeries;
      });
      seriesDocumentaryBox.put('documentarySeries', widget.documentarySeries);
    }
  }
