...
class _TopRatedSeriesState extends State<TopRatedSeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget Talk Show: ${widget.topRatedSeries.length}");
  }
  ...
  void loadSeries() {
    final cachedData = seriesTopRated.get('topRated');
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedTopRated = widget.topRatedSeries;
      });
      seriesTopRated.put('topRated', widget.topRatedSeries);
    }
  }
