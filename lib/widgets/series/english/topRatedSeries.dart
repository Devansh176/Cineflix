...
class _TopRatedSeriesState extends State<TopRatedSeries> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = topRatedSeriesBox.get('topRatedSeries');
      final cachedTimestamp = topRatedSeriesBox.get('topRatedSeriesTimestamp');
      ...
      await topRatedSeriesBox.put('topRatedSeries', widget.topRatedSeries);
      await topRatedSeriesBox.put('topRatedSeriesTimestamp', DateTime.now().toIso8601String());

      return widget.topRatedSeries;
    } catch (e) {
      return [];
    }
  }
