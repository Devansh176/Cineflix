...
class _HindiMysterySeriesState extends State<HindiMysterySeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget mysteryMovies: ${widget.hindiMysterySeries.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedMysterySeries = widget.hindiMysterySeries;
      });
      seriesMysteryBox.put('hindiMysterySeries', widget.hindiMysterySeries);
    }
  }
