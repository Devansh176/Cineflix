...
class _HindiRealityShowState extends State<HindiRealityShow> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedData = seriesRealityBox.get('hindiRealityShow');
      final cachedTimestamp = seriesRealityBox.get('hindiRealityShowTimestamp');
      ...
      await seriesRealityBox.put('hindiRealityShow', widget.hindiRealityShow);
      await seriesRealityBox.put('hindiRealityShowTimestamp', DateTime.now().toIso8601String());

      return widget.hindiRealityShow;
    } catch (e) {
      return [];
    }
  }
