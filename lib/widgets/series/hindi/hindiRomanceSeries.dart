...
class _HindiRomanceSeriesState extends State<HindiRomanceSeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget romanceSeries: ${widget.hindiRomanceSeries.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedRomanceSeries = widget.hindiRomanceSeries;
      });
      seriesRomanceBox.put('hindiRomanceSeries', widget.hindiRomanceSeries);
    }
  }
