...
class HindiFamilyShow extends StatefulWidget {
  const HindiFamilyShow({super.key, required this.hindiFamilyShow});
  final List hindiFamilyShow;

  @override
  State<HindiFamilyShow> createState() => _HindiFamilyShowState();
}

class _HindiFamilyShowState extends State<HindiFamilyShow> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget FamilySeries: ${widget.hindiFamilyShow.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedFamilySeries = widget.hindiFamilyShow;
      });
      seriesFamilyBox.put('hindiFamilySeries', widget.hindiFamilyShow);
    }
  }
