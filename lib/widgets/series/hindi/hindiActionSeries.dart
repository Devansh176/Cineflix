...
class _HindiActionSeriesState extends State<HindiActionSeries> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget actionMovies: ${widget.hindiActionSeries.length}");
  }
  ...
  void loadSeries() {
    ...
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedActionSeries = widget.hindiActionSeries;
      });
      seriesActionBox.put('hindiActionSeries', widget.hindiActionSeries);
    }
  }
