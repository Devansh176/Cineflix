...
class _HindiAnimationSeriesState extends State<HindiAnimationSeries> {
  ...
  Future<List> loadMovies() async {
    try {
      ...
      final cachedTimestamp = seriesAnimationBox.get('hindiAnimationSeriesTimestamp');
      ...
      await seriesAnimationBox.put('hindiAnimationSeries', widget.hindiAnimationSeries);
      await seriesAnimationBox.put('hindiAnimationSeriesTimestamp', DateTime.now().toIso8601String());

      return widget.hindiAnimationSeries;
    } catch (e) {
      return [];
    }
  }
