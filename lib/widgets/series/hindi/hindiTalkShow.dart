...
class HindiTalkShow extends StatefulWidget {
  const HindiTalkShow({super.key, required this.hindiTalkSeries});
  final List hindiTalkSeries;
...
class _HindiTalkShowState extends State<HindiTalkShow> {
  ...
  void initState() {
    super.initState();
    initializeHive();
    print("Widget Talk Show: ${widget.hindiTalkSeries.length}");
  }
  ...
  void loadSeries() {
    final cachedData = seriesTalkBox.get('hindiTalkSeries');
    if (cachedData != null && cachedData.isNotEmpty) {
      ...
      setState(() {
        cachedTalkShow = widget.hindiTalkSeries;
      });
      seriesTalkBox.put('hindiTalkSeries', widget.hindiTalkSeries);
    }
  }
