...
class _HindiMoviesState extends State<HindiMovies> {
  ...
  Future<void> loadMovies() async {
    try {
      Map<String, dynamic> topRatedMovieResult = await tmdbWithCustomLogs.v3.movies.getTopRated(language: 'en-US', region: 'IN') as Map<String, dynamic>;
      Map<String, dynamic> popularResult = await tmdbWithCustomLogs.v3.movies.getPopular(language: 'en-US', region: 'IN') as Map<String, dynamic>;
      Map<String, dynamic> upcomingMoviesResult = await tmdbWithCustomLogs.v3.movies.getUpcoming(language: 'en-US', region: 'IN') as Map<String, dynamic>;
      Map<String, dynamic> horrorMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '27', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> thrillerMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '53', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> actionMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '28', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> adventureMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '12', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> animationMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '16', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> comedyMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '35', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> romanceMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '10749', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> scienceFictionMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '878', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> documentaryMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '99', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> historyMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '36', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> mysteryMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '9648', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> westernMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '37', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> dramaMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '18', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> familyMoviesResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '10751', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> musicFilmsResult = await tmdbWithCustomLogs.v3.discover.getMovies(withGenres: '10402', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
