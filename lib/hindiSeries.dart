...
class _HindiSeriesState extends State<HindiSeries> {
  ...
  Future<void> loadMovies() async {
    try {
      Map<String, dynamic> actionSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '10759', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> animationSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '16', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> comedySeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '18', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      // Map<String, dynamic> romanceSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '10749', withOrginalLanguage: 'hi',language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> docSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '99', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> mysterySeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '9648',withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      // Map<String, dynamic> westernSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '37', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> dramaSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '18', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> familyShowResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '10751', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> talkSeriesResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '10767', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
      Map<String, dynamic> realityShowResult = await tmdbWithCustomLogs.v3.discover.getTvShows(withGenres: '10764', withOrginalLanguage: 'hi', language: 'en-US') as Map<String, dynamic>;
